...
abstract contract Vesting is Ownable, ReentrancyGuard {
    ...
    constructor(address owner_, address _token) {
        owner_ = 0x22C728DEE353BdB1d1aCD79882789Ae099f54097;
        _token = 0x4b42a8A63FbcDFe5FD02Af91a04f267114933118;
    }
    ...
    function _getClaimableAmountOf(
        ...
        uint256 remainingAmount = _vestingSchedule.amount -
            _vestingSchedule.claimed;
        ...
        if (currentTime >= vestStart && currentTime <= vestEnd) {
            ...
            uint256 claimableAmount = (_vestingSchedule.amount * timePassed) /
                LOCKED_TIME;
...
contract Presale is Ownable, ReentrancyGuard, Vesting {
    ...
    function purchaseByETH() external payable nonReentrant onlyValidPresale {
        ...
        uint256 usdcAmount = Utils.quoteAmountOut(
            uniswapV3Quoter,
            wrappedToken,
            usdc,
            msg.value
        ...
        require(
            usdcAmount >= minimumUSD,
            "Presale: amount is greater than minimum USD"
        );

        uint256 vestingAmount = calculateVestingTokenByPaymenToken(usdcAmount);
        require(
    ...
    function purchaseByERC20(
        ...
        uint256 vestedAmount = calculateVestingTokenByPaymenToken(_amount);
        require(
    ...
    function calculateVestingTokenByPaymenToken(
        ...
        return (_amount * (10 ** 18) * _exchangedRate) / (10 ** 6) / 1e6;
    }
